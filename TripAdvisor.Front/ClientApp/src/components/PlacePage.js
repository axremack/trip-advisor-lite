...
export class PlacePage extends Component {
	...
	renderCommentsList = () => {
		if ((this.state.Comments !== null) && (this.state.Comments.length !== 0)) {
			...
			return (<div className='jumbotron '><h2 className="display-4">Pas d'avis sur ce lieu</h2></div>);
		}
	}
			...
			<Container fluid className="pt-5">
				<Row>
					<Col md="4" className="mr-4">
						<PlaceCardDetailed key={this.state.Place.placeId} id={this.state.Place.placeId} title={this.state.Place.title} street={this.state.Place.street} zipCode={this.state.Place.zipCode} city={this.state.Place.city} state={this.state.Place.state}/>
					</Col>
					<Col className="mt-5">
